...
$mail->Username   = "shivarajshetty635@gmail.com";
$mail->Password   = "shetty@9423";
...
$mymail = 'shivarajshetty635@gmail.com';
$myname = 'Quiz Master';
...
if (isset($_POST["submit"])) {
    ...
    if (array_filter($errors)) {
        ...
        try {
            ...
            $mail->setFrom('shivarajshetty635@gmail.com', 'Quiz Master');
                    ...
                    <div class="offset-md-3 text-justify-content-end">
                      <div class="btn-group" role="group">
                        <a
                          role="button"
                          class="btn btn-info"
                          href="tel:+917483942724"
                          ><i class="fa fa-phone"></i> Call</a
                        >
                        <a role="button" class="btn btn-success" target="_blank" href="http://wa.me/7483942724?text=Message%20From%20Quiz%20Master." 
                          ><i class="fa fa-whatsapp"></i> Whatsapp</a
                        >
                        <a
                          role="button"
                          class="btn btn-primary"
                          href="mailto:shivarajshetty635@gmail.com"
