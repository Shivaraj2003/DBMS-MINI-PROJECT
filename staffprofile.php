...
require_once 'sql.php';
    ...
    if (isset($_POST['submit1'])){
      //echo "<script>window.location.replace(\"updateqs.php\")</script>";
      header("Location: updateqs.php");
    }
}
          ...
          <ul class="navbar-nav align-items-lg-center ml-auto">
            ...
            <li class="nav-item">
              <a href="updateqs.php" class="nav-link">
                <span class="text-white nav-link-inner--text font-weight-bold"
                  ><i class="text-danger fas fa-edit"></i> Update</span
                >
              </a>
            </li>
            ...
            <div class="col-md-4 mb-3">
                ...
                <div class="card-body bg-gradient-warning">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      ...
                      <p class="text-white font-size-sm">Mangalore Institute Of Technology & Engineering</p>
              ...
              <div class="card mb-3">
               ...
               <br>
                  ...
                  <div class="row">
                    <div class="col-sm-3">
                      <h6 class="mb-0 font-weight-bold">Staff ID</h6>
                    </div>
                    <div class="col-sm-9 text-dark">
                      <?php echo $dbstaffid ?>
                    </div>
